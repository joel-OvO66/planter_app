...
class MyBrnSelectTag extends StatefulWidget {
  /// 展示的标签列表
  ...
  MyBrnSelectTag({
    ...
    if (isSingleSelect == true) {
      assert(initTagState == null || (initTagState!.length <= 2));
    }
  ...
  @override
  _MyBrnSelectTagState createState() => _MyBrnSelectTagState();
}

class _MyBrnSelectTagState extends State<MyBrnSelectTag> {
  List<bool> _tagState = [];
  ...
  @override
  void didUpdateWidget(MyBrnSelectTag oldWidget) {
