...
class MyBrnTimeRangeWidget extends StatefulWidget {
  /// 可选最小时间
...
class _TimePickerWidgetState extends State<MyBrnTimeRangeWidget> {
  ...
  Widget _renderPickerView(BuildContext context) {
    ...
    if (widget.pickerTitleConfig.title != null ||
      ...
      return Column(children: <Widget>[titleWidget, ?custom, pickerWidget]);
    }
    return pickerWidget;
  }
