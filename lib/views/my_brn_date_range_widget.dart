...
class MyBrnDateRangeWidget extends StatefulWidget {
  /// 可选最小时间
...
class _DatePickerWidgetState extends State<MyBrnDateRangeWidget> {
    ...
    if (widget.pickerTitleConfig.title != null ||
      ...
      if (widget.customWidget != null) {
        custom = Container(
          ...
          height: widget.themeData!.itemHeight * 0.6,
          child: widget.customWidget,
        );
      }
      return Column(children: <Widget>[titleWidget, ?custom, datePickerWidget]);
    }
