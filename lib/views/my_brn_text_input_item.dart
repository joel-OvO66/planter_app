...
class MyBrnTextInputFormItem extends StatefulWidget {
  /// 录入项的焦点控制对象，主要用于控制焦点
  ...
  State<StatefulWidget> createState() {
    return MyBrnTextInputFormItemState();
  }
}

class MyBrnTextInputFormItemState extends State<MyBrnTextInputFormItem> {
