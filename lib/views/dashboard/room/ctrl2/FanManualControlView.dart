 ...
 **/
class FanManualControlView extends StatefulWidget {
  final String deviceId;

  final ManModeParam manModeParam;

  const FanManualControlView({Key? key, required this.deviceId, required this.manModeParam}) : super(key: key);

  @override
  _FanManualControlViewState createState() => _FanManualControlViewState();
}

/**
 * FanControlTabView UI布局
 **/
class _FanManualControlViewState extends State<FanManualControlView> with SingleTickerProviderStateMixin {
  ...
  Widget _buildManualWidget() {
    return BasicCard(
      title: S.of(context).fan, //"Fan Speed",
      child: Column(
        children: <Widget>[
