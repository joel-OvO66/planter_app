...
part of 'HistoricTaskInstanceInfo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HistoricTaskInstanceInfo _$HistoricTaskInstanceInfoFromJson(
    ...
    HistoricTaskInstanceInfo()
      ...
      ..workTimeInMillis = (json['workTimeInMillis'] as num?)?.toInt();

Map<String, dynamic> _$HistoricTaskInstanceInfoToJson(
        HistoricTaskInstanceInfo instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      ...
      'workTimeInMillis': instance.workTimeInMillis,
    };
